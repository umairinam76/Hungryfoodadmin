...
!(function (t, s, e, i) {
  ...
  function a(s, e) {
    (this.element = s),
      (this.settings = t.extend(!0, {}, r, e)),
      (this._defaults = r),
      (this._name = n),
      (this._ready = !1),
      (this.currentPage = this.settings.page),
      (this.items = t(this.element).find(
        this.settings.itemsContainer + " " + this.settings.item
      )),
      (this.totalPages = Math.ceil(
        this.items.length / this.settings.itemsPerPage
      )),
      this.totalPages <= 1
        ? t(this.element).find(this.settings.pager).hide()
        : this.init();
  }
  var n = "paginga",
    r = {
      ...
      pager: ".pager",
      autoHidePager: !0,
      scrollToTop: { offset: 15, speed: 100 },
      history: !1,
  ...
  t.extend(a.prototype, {
    init: function () {
      if ((this.bindEvents(), this.showPage(), this.settings.history)) {
        ...
        if (s.location.hash) {
          var e = parseInt(
            s.location.hash.substring(t.settings.historyHashPrefix.length + 1),
            10
          );
          e <= t.totalPages &&
            e > 0 &&
            ((t.currentPage = e), t.showPage.call(t));
        }
        s.addEventListener("popstate", function (s) {
          (t.currentPage =
            s && s.state && s.state.page ? s.state.page : t.settings.page),
            t.showPage.call(t);
        });
      }
      this._ready = !0;
    ...
    showPage: function () {
      ...
      a._ready &&
        a.settings.scrollToTop &&
        n.offset().top - a.settings.scrollToTop.offset < t(s).scrollTop() &&
        t("html, body").animate(
          { scrollTop: n.offset().top - a.settings.scrollToTop.offset },
          a.settings.scrollToTop.speed
        ),
        this.currentPage <= 1
          ? (r.addClass("disabled"), h.addClass("disabled"))
          : (r.removeClass("disabled"), h.removeClass("disabled")),
        this.currentPage >= this.totalPages
          ? (g.addClass("disabled"), o.addClass("disabled"))
          : (g.removeClass("disabled"), o.removeClass("disabled"));
      ...
      if (P) {
        ...
        if (this.settings.maxPageNumbers) {
          ...
          (c = Math.max(1, this.currentPage - d)),
            (u = Math.min(this.totalPages, this.currentPage + d)),
            u - c < this.settings.maxPageNumbers - 1 &&
              (d >= c
                ? (u = Math.min(
                    this.totalPages,
                    c + this.settings.maxPageNumbers - 1
                  ))
                : u > this.totalPages - d &&
                  (c = Math.max(1, u - this.settings.maxPageNumbers + 1)));
        }
        for (var f = c; u >= f; f++) {
        ...
        P.find("a").on("click", function () {
          (a.currentPage = t(this).data("page")),
            a.setHistoryUrl.call(a),
            a.showPage.call(a);
        });
      }
    },
    setHistoryUrl: function () {
      ...
      t._ready &&
        ...
        history.pushState(
          ...
          null,
          "#" + t.settings.historyHashPrefix + this.currentPage
        );
    },
  }),
    (t.fn[n] = function (s) {
      return this.each(function () {
        t.data(this, "plugin_" + n) ||
          t.data(this, "plugin_" + n, new a(this, s));
      });
    });
