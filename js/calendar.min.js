!(function (s) {
  ...
  function w(t) {
    t = t.getMonth() + 1 + " 1 " + t.getFullYear();
    return new Date(t);
  }
  function b(t) {
  ...
  function i(t, e) {
    var n,
      ...
      i =
        ...
        (n = n.getFullYear()),
        0 === l && (--n, (l = 12)),
        new Date(n, l, 0).getDate()),
      r = [],
      l = a.getDay(),
      c = 1;
    if (1 === e) {
      for (var g = l - 1; 0 <= g; g--) {
        var u = new Date(t.getFullYear(), t.getMonth() - 1, i - g);
        r.push(u);
      }
      for (var d = 7 - r.length, h = 0; h < d; h++) {
        u = new Date(a.getFullYear(), a.getMonth(), s + h);
        r.push(u);
      }
    } else
      for (var f = 7 * (e - 1) - l, v = 1; v <= 7; v++)
        (u =
          f + v <= o
            ? new Date(t.getFullYear(), t.getMonth(), f + v)
            : new Date(t.getFullYear(), t.getMonth() + 1, c++)),
          r.push(u);
    return r;
  }
  function r(t, e) {
      ...
      g
        ? ((a += '<div class="months-container">'),
          ...
          (a += (function (t) {
            var e,
              n = "";
            for (e in ((n += '<div class="months-wrapper">'), u))
              u.hasOwnProperty(e) &&
                (n +=
                  '<span class="month' +
        ...
        : ((a += '<div class="weeks-container">'),
          ...
          (a += (function () {
            var t,
              e = "";
            for (t in ((e += '<div class="weeks-wrapper header">'),
            (e += '<div class="week" data-week-no="0">'),
            d))
              d.hasOwnProperty(t) &&
                (e +=
                  ...
                  t +
                  '">' +
                  d[t].substring(0, settings.weekDayLength) +
                  "</div>");
            return (e += "</div>"), (e += "</div>");
          })()),
          (a +=
            ...
            t.forEach(function (t, e) {
              (r += '<div class="week" data-week-no="' + (e + 1) + '">'),
                t.forEach(function (t, e) {
                  var n = !1;
                  t.getMonth() !== i.getMonth() && (n = !0),
                    (n = n ? " disabled" : "");
                  var a = !1,
                    a = c
                      ? (t == c.toString() && (a = !0), a ? " selected" : "")
                      : "",
                    s = !1;
                  t == l.toString() && (s = !0), (s = s ? " today" : "");
                  var o = "ola";
          ...
          o
            ...
            .on("click", ".months-container .month", function (t) {
              var e = s(this),
                ...
                e = e.data("year"),
                n = new Date(e, n - 1, 1);
              settings.onChangeMonth(n), (g = !1), h((a = n));
            }),
          o
        ...
        settings.showTodayButton &&
          o
            ...
            .on("click", ".today-button", function (t) {
              (c = a = l), settings.onClickToday(l), (g = !1), h(a);
            }),
        this
      );
    });
